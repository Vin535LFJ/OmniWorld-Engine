...
See the consolidated architecture in `docs/ARCHITECTURE.md`. This document owns the detailed design for the world-state area and must remain benchmark-driven.
